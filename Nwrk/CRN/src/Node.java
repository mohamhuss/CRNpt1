...
public class Node implements NodeInterface {
    ...
    private void processMessage(String message, DatagramPacket packet) throws Exception {
        ...
        // Extract the 2-byte transaction ID
        String txid = message.substring(0, 2);
        char command = message.charAt(2);
        String args = message.length() > 3 ? message.substring(3) : "";
    ...
    private String generateTransactionID() {
        ...
        String txid = String.format("%04x", counter % 65536);
